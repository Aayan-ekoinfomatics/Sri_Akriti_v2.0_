...
import termsAndConditionsApi from '../../mockapi/termsAndConditionsApi'
    ...
    <div className='w-full pb-[100px]'>
      ...
      <div className='w-full px-4'>
        ...
        <div className='w-full flex justify-center items-center text-center mt-5 md:mt-0'>
          <h1 className='text-[20px] md:text-[26px] font-[600]'>Terms & Conditions</h1>
        </div>

        {/* body */}
        <div className='mt-16 w-[95%] md:w-[75%] mx-auto'>
          ...
          <div className='w-full mt-10'>
            {
              termsAndConditionsApi?.terms?.map((data, i) => (
