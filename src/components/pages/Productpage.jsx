              ...
              <div className="hidden md:flex w-full justify-center">
                {
                  productApiData ?
                    ...
                    <div className="w-full flex justify-end">
                      {/* skeleton body */}
                      <div className='flex flex-col w-full max-w-[600px] justify-center aspect-square items-center relative overflow-hidden bg-[#dfdddd]'>
                        <div className='w-full'>
                          {/* Skeleton loader*/}
              ...
              <div className="w-full hidden md:flex justify-evenly px-4 items-center mt-2">
                {
                  productApiData ?
                    ...
                    <div className="w-full flex justify-end gap-5">
                      ...
                      {/* skeleton body */}
                      <div className='flex flex-col w-full max-w-[130px] justify-center aspect-square items-center relative overflow-hidden bg-[#dfdddd]'>
                        <div className='w-full'>
                          {/* Skeleton loader*/}
                          <div className={`absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#dfdddd] via-[#ecebebc9] to-[#dfdddd] w-full skeleton-animation `}></div>
                        </div>
        ...
        <div className="pt-6 md:pt-0 lora w-[95%] md:w-[60%] mx-auto tracking-[2px] flex flex-col lg:flex-row md:justify-between md:items-center mb-10">
...

          {
            productApiData ?
              ...
              :
              <div className="w-full md:border-r md:border-r-[#D9D9D9]">
                <div className='w-[80%] mx-auto flex flex-col gap-8'>

                  {/* skeleton body */}
                  <div className='flex flex-col w-full justify-center h-[60px] items-center relative overflow-hidden bg-[#dfdddd]'>
                    <div className='w-full'>
                      {/* Skeleton loader*/}
                      <div className={`absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#dfdddd] via-[#ecebebc9] to-[#dfdddd] w-full skeleton-animation `}></div>
                    </div>
                  ...
                  {/* skeleton body */}
                  <div className='flex flex-col w-full justify-center h-[100px] items-center relative overflow-hidden bg-[#dfdddd]'>
                    <div className='w-full'>
                      {/* Skeleton loader*/}
                      <div className={`absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#dfdddd] via-[#ecebebc9] to-[#dfdddd] w-full skeleton-animation `}></div>
                    </div>
                  ...
                  {/* skeleton body */}
                  <div className='flex flex-col w-full justify-center h-[40px] items-center relative overflow-hidden bg-[#dfdddd]'>
                    <div className='w-full'>
                      {/* Skeleton loader*/}
                      <div className={`absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#dfdddd] via-[#ecebebc9] to-[#dfdddd] w-full skeleton-animation `}></div>
                    </div>
...

          {
            productApiData ?
              ...
              :
              <div className="w-full flex flex-col justify-between gap-10 translate-y-[100px]">
                <div className="w-full gap-2 flex flex-col justify-end">
                  {/* skeleton body */}
                  <div className='flex flex-col w-full justify-center h-[30px] items-center relative overflow-hidden bg-[#dfdddd]'>
                    <div className='w-full'>
                      {/* Skeleton loader*/}
                      <div className={`absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#dfdddd] via-[#ecebebc9] to-[#dfdddd] w-full skeleton-animation `}></div>
                    </div>
