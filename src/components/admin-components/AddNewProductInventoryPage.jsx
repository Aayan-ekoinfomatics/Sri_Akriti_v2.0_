...
const AddNewProductInventoryPage = () => {
    ...
    useEffect(() => {
        ...
        axios.get(import.meta.env.VITE_APP_BASE_API_LINK + 'adminAddNewProduct').then((response) => {
    ...
    const submitForm = (e) => {
        axios.post(import.meta.env.VITE_APP_BASE_API_LINK + 'adminAddNewProduct', defaultData).then((response) => {
                                ...
                                <div className='w-full min-w-[1000px] roboto'>
                                        ...
                                        <div className='w-full pt-10'>
                                            ...
                                            </div>
                                            {
                                                ...
                                                <div className='w-full flex flex-col my-2 max-w-[500px]'>
                                                    ...
                                                    <div className='w-full rounded-[10px] z-[120] bg-white shadow-md py-[5px] pl-3 my-1 cursor-pointer flex justify-between items-center pr-3' onClick={() => setCategoryDropDown(!categoryDropDown)}>
                                                        <div className='text-[15px] text-[#696969b6] uppercase'>{category === '' ? 'Select a category' : category}</div>
                                                        <div><img src={down} className="" /></div>
                                                    </div>
                                                    <div className={`fixed max-w-[500px] z-[120] mt-[80px] rounded-[10px] shadow-md bg-white w-full overflow-hidden transition-all duration-300 ${categoryDropDown ? 'h-[150px] ease-in px-4 py-2' : 'h-0 ease-out p-0'}`}>
                                                        {
                                                            defaultData?.category_all?.map((data, i) => {
                                                                return (
                                                                    <li key={i} className='uppercase text-[14px] list-none roboto w-full hover:bg-[#dddddd] my-1 px-2 py-1 cursor-pointer rounded-md' onClick={() => {
                                                                        setCategory(data)
                                                                        setDefaultData({
                                                                            ...defaultData,
                                                                            category: data
                                                    ...
                                                    <div className={`fixed bottom-0 top-0 left-0 right-0 bg-black opacity-40 z-[100] ${categoryDropDown ? 'block' : 'hidden'}`} onClick={() => setCategoryDropDown(false)}>
                                            ...
                                            <div className='w-full flex flex-col my-2 max-w-[500px]'>
                                                ...
                                                {/* <input type="text" value={selectedDiamondQuality} name="product name" className='outline-none py-[6px] px-3 my-1 rounded-[8px] shadow-md text-[13px]' placeholder='Category Name' /> */}
                                                        {/* <div className='w-full py-[6px] px-3 my-1 rounded-[8px] shadow-md text-[13px]'>
                                                            {selectedDiamondQuality}sssssssssssssssssssssssssssssssss
                                                        </div> */}
                                            </div>
                                        ...
                                        <div className='w-full flex flex-col gap-2 justify-end pr-[120px]'>
                                            ...
                                            <div className='w-full pt-14 flex justify-end gap-2 relative'>
                                                <label htmlFor="file_image" className=' h-full min-h-[200px] relative flex aspect-square'>
                                                    <input type="file" name='file' className='opacity-0 z-[200]' accept="image/*" onChange={(e) => {
                                                        console.log(e.target.files[0])
                                                        let formdata = new FormData()
                                    ...
                                    <div className='flex justify-around items-start'>
                                        ...
                                        <div className='w-fit flex flex-col gap-3 justify-between items-end'>
                                                ...
                                                defaultData?.diamond_size?.map((data, index) => (
                                                    <div key={index} className='w-full flex gap-5 justify-between items-center'>
                                                        <div className='w-fit flex justify-between'>
                                                            <input type="text" value={data} className='py-1 px-2 rounded-[10px] shadow-md' placeholder='diamond size' />
                                                        </div>
                                                        <span>
                                                            <img src={delete_icon} className='w-[12px] cursor-pointer active:scale-[0.96]' alt="" onClick={() => {
                                            ...
                                            <span className='relative flex justify-between gap-3 items-center w-full z-[500]'>
                                                <div className='w-full min-w-[100px] flex justify-between gap-3 bg-[#69696944] py-[6px] px-[8px] rounded-[10px] cursor-pointer' onClick={() => setDiamondSizeDropdown(!diamondSizeDropdown)}>
                                                    <p className='text-[12px] w-full'>{selectedDiamondSize}</p>
                                                    <img src={down} className="w-[16px]" />
                                                </div>
                                                ...
                                                <div className='w-full flex justify-end'>
                                                    <button className='w-full min-w-[80px] py-[6px] px-3 rounded-[8px] text-[12px] bg-[#69696980] active:bg-[#d6d6d6] active:scale-[0.91]' onClick={() => {
